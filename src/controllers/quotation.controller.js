...
exports.createQuotation = async (req, res) => {
  try {
    ...
    pusher.trigger(`user-${userId}`, "quotation_generated", {
    ...
    // Notify Admin
    pusher.trigger("admin-channel", "quotation_updated", {
...
exports.acceptQuotation = async (req, res) => {
  try {
    ...
    pusher.trigger(`partner-${quotation.partnerId}`, "quotation_updated", {
